...
- **[dynamic-offer-allocation](https://github.com/interactive-decision-support-system/dynamic-offer-allocation)** — Budget-aware contextual offer allocation: a primal-dual pacer with swappable CATE estimators (logistic / neural net) over a multi-feature context, validated against benchmark policies and an LP optimum, with interchangeable synthetic and live-LLM data generators. It now also ships an in-repo pipeline that derives personas from review data and gates them on offer-response separation. See [in-flight and backlog work](https://github.com/orgs/interactive-decision-support-system/projects/2/views/10) on the project board.
